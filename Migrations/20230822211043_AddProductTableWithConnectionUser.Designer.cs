...
namespace dosLogistic.API.Migrations
{
    ...
    [Migration("20230822211043_AddProductTableWithConnectionUser")]
    partial class AddProductTableWithConnectionUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dosLogistic.API.Models.Foundations.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("73965a93-b16a-4358-b77a-9ffc573d39fe"),
                            BirthDate = new DateTimeOffset(new DateTime(2023, 8, 23, 2, 10, 42, 979, DateTimeKind.Unspecified).AddTicks(6472), new TimeSpan(0, 5, 0, 0, 0)),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 8, 23, 2, 10, 42, 979, DateTimeKind.Unspecified).AddTicks(6366), new TimeSpan(0, 5, 0, 0, 0)),
                            ...
                            PhoneNumber = "0",
                            Role = 0,
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 8, 23, 2, 10, 42, 979, DateTimeKind.Unspecified).AddTicks(6366), new TimeSpan(0, 5, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("1a05ea9d-776d-40bc-84c6-cf6a7979b172"),
                            BirthDate = new DateTimeOffset(new DateTime(2023, 8, 23, 2, 10, 42, 979, DateTimeKind.Unspecified).AddTicks(6512), new TimeSpan(0, 5, 0, 0, 0)),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 8, 23, 2, 10, 42, 979, DateTimeKind.Unspecified).AddTicks(6366), new TimeSpan(0, 5, 0, 0, 0)),
